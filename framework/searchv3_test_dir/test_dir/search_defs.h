 ...
 *  on 2025-03-13 21:33:26.
 *  It defines constants, structures, and function declarations for the SEARCH module.
 *
 *  These contents are extracted automatically from the **source file**: `tcp_cubic_search.c`,
...
extern void bictcp_search_reset(struct bictcp *ca);
...
extern void search_exit_slow_start(struct sock *sk);
